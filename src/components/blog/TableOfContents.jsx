...
export default function TableOfContents({ headings = [] }) {
    ...
    useEffect(() => {
        ...
        // Find all headings in the article and ensure they have IDs matching the server extraction
    ...
    return (
        <div ref={ref} className="relative">
            ...
            {open && (
                <div className="absolute top-12 right-0 w-72 max-h-80 overflow-y-auto custom-scrollbar bg-white/95 dark:bg-neutral-950/95 backdrop-blur-xl border border-gray-200 dark:border-neutral-800 rounded-2xl shadow-2xl p-3 z-50">
